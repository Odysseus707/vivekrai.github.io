...
export const PROJECTS: Project[] = [
  {
    title: 'NGO Website',
    date: 'JAN 2023',
    subtext: 'Developed a web application for Sarvodaya Welfare Society - an NGO',
    url: '',
  },
  {
    title: 'Vertex AI Sentiment',
    date: 'JUL 2023',
    subtext: 'Built an NLP sentiment system on Google Cloud Vertex AI (92% accuracy) and trimmed inference latency by ~40%.',
    url: '',
  },
  {
